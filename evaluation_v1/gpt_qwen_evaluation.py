#app/evaluation_v1/gpt_evaluation.py
"""
This script evaluates the performance of two models on a set of queries.
It uses the OpenAI API to evaluate the models and save the results to a JSON file.
It performs the evaluation on gpt model and qwen-base model. 
"""
...
# Replace this with your actual API key and endpoint if different
